...
class TestParseWts(unittest.TestCase):
    ...
    def test_body_preserves_internal_crlf_tabs_quotes_and_outer_spaces(self):
        # Given: structural braces use CRLF and the body has significant whitespace.
        data = b'STRING 9\r\n{\r\n  "first\t  \r\nsecond  \r\n}\r\n'

        # When / Then: only the two container line endings are removed.
        self.assertEqual(parse_wts(data)[9], '  "first\t  \r\nsecond  ')

    def test_body_preserves_lone_cr_line_endings(self):
        # Given: a legacy WTS uses lone carriage returns.
        data = b"STRING 10\r{\rfirst\rsecond\r}\r"

        # When / Then: the internal separator remains a carriage return.
        self.assertEqual(parse_wts(data)[10], "first\rsecond")
